...
public class Class78 {
	...
	static String method1382(Date date_0, String string_1, TimeZone timezone_2, Language xlanguage_3) {
		if (aMap766 == null) {
			...
			for (Language xlanguage_7 : arr_5)
	...
	static int method1386(Class413 class413_0) {
		if (class413_0 == null)
			return 12;
		return switch (class413_0.anInt4972) {
		case 5 -> 20;
		default -> 12;
		};
	}
	...
	static void method1388(int i_0, int i_1, int i_2, int i_3, int i_4) {
		...
		int i_21 = i_2;
		int i_31 = i_3;
		if (i_21 <= Class532.anInt7068 && i_31 >= Class532.anInt7070) {
			boolean bool_6;
			if (i_01 < Class532.anInt7071) {
				i_01 = Class532.anInt7071;
				bool_6 = false;
			} else if (i_01 > Class532.anInt7069) {
				i_01 = Class532.anInt7069;
				bool_6 = false;
			} else
				bool_6 = true;
			boolean bool_7;
			if (i_11 < Class532.anInt7071) {
				i_11 = Class532.anInt7071;
				bool_7 = false;
			} else if (i_11 > Class532.anInt7069) {
				i_11 = Class532.anInt7069;
				bool_7 = false;
			} else
				bool_7 = true;
			if (i_21 >= Class532.anInt7070)
				KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_21++], i_01, i_11, i_4);
			else
				i_21 = Class532.anInt7070;
			if (i_31 <= Class532.anInt7068)
				KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_31--], i_01, i_11, i_4);
			else
				i_31 = Class532.anInt7068;
			int i_8;
			if (bool_6 && bool_7)
				for (i_8 = i_21; i_8 <= i_31; i_8++) {
					int[] ints_9 = Class532.anIntArrayArray7072[i_8];
					ints_9[i_01] = ints_9[i_11] = i_4;
				}
			else if (bool_6)
				for (i_8 = i_21; i_8 <= i_31; i_8++)
					Class532.anIntArrayArray7072[i_8][i_01] = i_4;
			else if (bool_7)
				for (i_8 = i_21; i_8 <= i_31; i_8++)
					Class532.anIntArrayArray7072[i_8][i_11] = i_4;
		}
	}
