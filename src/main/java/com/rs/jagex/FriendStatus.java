	...
	static void method7703() {
		if (client.CURRENT_CUTSCENE < 0) {
			...
			if (!Class20.aBool161)
				...
				int i_3;
				for (MenuActionEvent class282_sub50_sub7_2 = (MenuActionEvent) Class20.aClass482_171.head(); class282_sub50_sub7_2 != null; class282_sub50_sub7_2 = (MenuActionEvent) Class20.aClass482_171.next()) {
					MenuAction action = class282_sub50_sub7_2.menuAction;
					if (action.getId() < 1000) {
						class282_sub50_sub7_2.unlink();
						if (action.isTargetOp())
				...
				if (Class20.anInt169 <= 1) {
					...
					if (Preference_Sub1.method12619() && Class20.anInt169 > 2)
						CutsceneAction_Sub23.aCacheableNode_Sub7_9445 = (MenuActionEvent) Class20.aClass482_171.tail.previous.previous;
					else
						CutsceneAction_Sub23.aCacheableNode_Sub7_9445 = (MenuActionEvent) Class20.aClass482_171.tail.previous;
					AccountCreationStage.aCacheableNode_Sub7_12 = (MenuActionEvent) Class20.aClass482_171.tail.previous;
					if (Class20.anInt169 > 2)
						Class20.aCacheableNode_Sub7_168 = (MenuActionEvent) AccountCreationStage.aCacheableNode_Sub7_12.previous;
					else
						Class20.aCacheableNode_Sub7_168 = null;
				}
				...
				if (Class20.aBool161) {
					...
					if (Friend.method302(Class149_Sub2.DEFAULTS_LOADER_7.anInterface17_5882, class282_sub53_14)) {
						int i_5;
						MenuActionEvent class282_sub50_sub7_8;
