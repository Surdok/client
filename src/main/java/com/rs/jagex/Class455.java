...
public abstract class Class455 {
	...
	static void iComponentOnIComponent(IComponentDefinitions icomponentdefinitions_0) {
		if (client.IS_USE_SELECTED) {
			ParamDefinitions attributedefault_4 = CutsceneAction_Sub12.TARGET_PARAM != -1 ? IndexLoaders.PARAM_LOADER.getParam(CutsceneAction_Sub12.TARGET_PARAM) : null;
			if (client.getIComponentSettings(icomponentdefinitions_0).canBeUsedWith() && (Class506.USE_OPTIONS_FLAGS & 0x20) != 0 && (attributedefault_4 == null || icomponentdefinitions_0.method1997(CutsceneAction_Sub12.TARGET_PARAM, attributedefault_4.defaultInt) != attributedefault_4.defaultInt))
				PlayerModel.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + icomponentdefinitions_0.useOnName, Defaults8Loader.anInt5932, MenuAction.TGT_BUTTON, icomponentdefinitions_0.containerItemId, 0L, icomponentdefinitions_0.slotId, icomponentdefinitions_0.idHash, true, false, icomponentdefinitions_0.slotId << 0 | icomponentdefinitions_0.idHash, false);
		}
		for (int i_7 = 9; i_7 >= 5; --i_7) {
			String string_8 = ItemIndexLoader.method7171(icomponentdefinitions_0, i_7);
			if (string_8 != null)
				PlayerModel.method4032(string_8, icomponentdefinitions_0.useOnName, Class520.method11163(icomponentdefinitions_0, i_7), MenuAction.IF_BUTTONX2, icomponentdefinitions_0.containerItemId, i_7 + 1, icomponentdefinitions_0.slotId, icomponentdefinitions_0.idHash, true, false, icomponentdefinitions_0.slotId << 0 | icomponentdefinitions_0.idHash, false);
		}
		String string_9 = QuickChatMessage.method6157(icomponentdefinitions_0);
		if (string_9 != null)
			PlayerModel.method4032(string_9, icomponentdefinitions_0.useOnName, icomponentdefinitions_0.anInt1378, MenuAction.SELECT_TGT, icomponentdefinitions_0.containerItemId, 0L, icomponentdefinitions_0.slotId, icomponentdefinitions_0.idHash, true, false, icomponentdefinitions_0.slotId << 0 | icomponentdefinitions_0.idHash, false);
		for (int i_5 = 4; i_5 >= 0; --i_5) {
			String string_6 = ItemIndexLoader.method7171(icomponentdefinitions_0, i_5);
			if (string_6 != null)
				PlayerModel.method4032(string_6, icomponentdefinitions_0.useOnName, Class520.method11163(icomponentdefinitions_0, i_5), MenuAction.IF_BUTTONX1, icomponentdefinitions_0.containerItemId, i_5 + 1, icomponentdefinitions_0.slotId, icomponentdefinitions_0.idHash, true, false, icomponentdefinitions_0.slotId << 0 | icomponentdefinitions_0.idHash, false);
		}
		if (client.getIComponentSettings(icomponentdefinitions_0).continueOptionEnabled())
			if (icomponentdefinitions_0.opName != null)
				PlayerModel.method4032(icomponentdefinitions_0.opName, "", -1, MenuAction.IF_CONTINUE, icomponentdefinitions_0.containerItemId, 0L, icomponentdefinitions_0.slotId, icomponentdefinitions_0.idHash, true, false, icomponentdefinitions_0.slotId << 0 | icomponentdefinitions_0.idHash, false);
			else
				PlayerModel.method4032(LocalizedText.CONTINUE.translate(Class223.CURRENT_LANGUAGE), "", -1, MenuAction.IF_CONTINUE, icomponentdefinitions_0.containerItemId, 0L, icomponentdefinitions_0.slotId, icomponentdefinitions_0.idHash, true, false, icomponentdefinitions_0.slotId << 0 | icomponentdefinitions_0.idHash, false);
	}
