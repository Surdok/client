...
public class Class155 {
	...
	static void method2637(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5) {
		...
		while (i_9 > i_7) {
			...
			if (i_10 >= 0) {
				...
				i_10 -= i_9 << 1;
				if (i_9 >= i_8) {
					ints_18 = Class532.anIntArrayArray7072[i_9 + i_1];
					ints_19 = Class532.anIntArrayArray7072[i_1 - i_9];
					i_20 = i_0 + i_7;
					i_21 = i_0 - i_7;
			...
			ints_18 = Class532.anIntArrayArray7072[i_7 + i_1];
			ints_19 = Class532.anIntArrayArray7072[i_1 - i_7];
			i_20 = i_0 + i_9;
			i_21 = i_0 - i_9;
			if (i_7 < i_8) {
	...
	static PathingEntity method2640(int i_0, int i_1, int i_2) {
		...
		for (Class208 class208_7 = class293_4.aClass208_3504; class208_7 != null; class208_7 = class208_7.aClass208_2660) {
			...
			if (class521_sub1_sub1_8 instanceof PathingEntity animable_9) {
